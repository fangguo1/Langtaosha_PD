...
-- ============================================================================
-- 13. user_study_events（用户研究事件日志）
-- ============================================================================
-- 轻量 Study Mode 日志表：搜索事件和结果反馈事件统一写入此表。
...
-- ============================================================================
-- 14. user_study_search_results（用户研究搜索结果快照）
-- ============================================================================
-- 每次 Study Mode 搜索完成后，按返回顺序记录本次暴露给用户的结果列表。
...
-- ============================================================================
-- 15. retrieval_testbed_queries（检索反馈测试集 query）
-- ============================================================================
...
-- ============================================================================
-- 16. retrieval_testbed_judgments（检索反馈测试集 judgment）
-- ============================================================================
...
-- ============================================================================
-- 17. retrieval_testbed_versions（冻结测试集版本）
-- ============================================================================
...
-- ============================================================================
-- 18. retrieval_testbed_version_items（冻结 query-doc judgment）
-- ============================================================================
...
-- ============================================================================
-- 19. retrieval_evaluation_runs（检索评测运行）
-- ============================================================================
...
-- ============================================================================
-- 20. retrieval_evaluation_results（检索评测排名输出）
-- ============================================================================
...
-- ============================================================================
-- 21. retrieval_evaluation_query_metrics（单 query 指标）
-- ============================================================================
...
BEGIN
    ...
    RAISE NOTICE '已创建的表（0413 简化版，共 21 张）：';
    ...
    RAISE NOTICE '  13. user_study_events（用户研究事件日志）';
    RAISE NOTICE '  14. user_study_search_results（用户研究搜索结果快照）';
    RAISE NOTICE '  15. retrieval_testbed_queries（检索反馈测试集 query）';
    RAISE NOTICE '  16. retrieval_testbed_judgments（检索反馈测试集 judgment）';
    RAISE NOTICE '  17. retrieval_testbed_versions（冻结测试集版本）';
    RAISE NOTICE '  18. retrieval_testbed_version_items（冻结 query-doc judgment）';
    RAISE NOTICE '  19. retrieval_evaluation_runs（检索评测运行）';
    RAISE NOTICE '  20. retrieval_evaluation_results（检索评测排名输出）';
    RAISE NOTICE '  21. retrieval_evaluation_query_metrics（单 query 指标）';
    RAISE NOTICE '';
